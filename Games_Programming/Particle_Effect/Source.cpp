...
ParticleEffect effect = ParticleEffect(glm::vec3(0.0f, 0.0f, 0.0f), 0);
...
float			disp = -5.0;
float			fovy = 45.0f;
float			posX = 0.0f, posY = 0.0f, posZ = 50.0f;
...
void startup() {
	...
	effect = ParticleEffect(glm::vec3(0.0f, 0.0f, 0.0f), 10);
...
void update(double currentTime) {
	...
	/*glm::mat4 mv_matrix_sphere2 =
		...
		glm::translate(effect.getPosition()) *
		//glm::translate(phys.getDisplacement()) *
		//glm::rotate(-t, glm::vec3(0.0f, 1.0f, 0.0f)) *
		//glm::rotate(-t, glm::vec3(1.0f, 0.0f, 0.0f)) *
		glm::scale(glm::vec3(1.0f, 1.0f, 1.0f)) *
		glm::mat4(1.0f);
	effect.mv_matrix =viewMatrix * mv_matrix_sphere2;
	effect.proj_matrix = myGraphics.proj_matrix;*/
...
*/
	...
	glm::mat4 viewMatrix = glm::lookAt(cameraPosition,					// eye
		...
		cameraUp);						// up
	int i = 0;
	for each(Particle p in effect.particles) {
		cout <<  p.getPosition().x << ", "<< p.getPosition().y << endl;
		glm::mat4 mv_matrix_sphere2 =
			//glm::translate(glm::vec3(0.0f, phys.getDisplacement(), -50.0f)) *
			//glm::rotate(-90.0f, glm::vec3(0.0f, 1.0f, 0.0f)) *
			glm::translate(p.m_Position) *
			//glm::translate(phys.getDisplacement()) *
			//glm::rotate(-t, glm::vec3(0.0f, 1.0f, 0.0f)) *
			//glm::rotate(-t, glm::vec3(1.0f, 0.0f, 0.0f)) *
			glm::scale(glm::vec3(1.0f, 1.0f, 1.0f)) *
